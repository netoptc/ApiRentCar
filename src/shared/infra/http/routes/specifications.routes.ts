...
specificationsRoutes.post("/", userAdminMiddleware, createSpecificationController.handle);
specificationsRoutes.get("/", userAdminMiddleware, listSpecificationController.handle);
